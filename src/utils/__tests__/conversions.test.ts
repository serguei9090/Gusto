...
import { convertUnit, getUnitType, MASS_UNITS, VOLUME_UNITS } from "../conversions";
...
describe("Unit Conversions", () => {
    ...
    describe("convertUnit - Error Handling", () => {
        it("should throw error for mass to volume conversion", () => {
            ...
            expect(() => convertUnit(10, "kg", "ml")).toThrow(/Cannot convert incompatibility unit types/);
        });

        it("should throw error for volume to mass conversion", () => {
            expect(() => convertUnit(10, "l", "g")).toThrow();
            expect(() => convertUnit(10, "ml", "kg")).toThrow(/Cannot convert incompatibility unit types/);
        });
