...
import type { CreateTransactionInput, InventoryTransaction } from "@/features/inventory/types";

class InventoryRepository {
    async logTransaction(data: CreateTransactionInput): Promise<InventoryTransaction> {
        const { ingredientId, transactionType, quantity, costPerUnit, totalCost, reference, notes } = data;
