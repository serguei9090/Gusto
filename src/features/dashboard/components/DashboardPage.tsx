...
import { Package, AlertTriangle, Percent, ChefHat } from "lucide-react";

export const DashboardPage = () => {
    const { summary, urgentReorders, topRecipes, fetchDashboardData, isLoading, error } = useDashboardStore();
