            ...
            <CardContent>
                {recipes.length === 0 ? (
                    ...
                    <div className="space-y-4">
                        {recipes.map((recipe) => (
                            <div key={recipe.id} className="flex items-center justify-between border-b pb-2 last:border-0 last:pb-0">
                                ...
                                <Badge
                                    ...
                                    className={recipe.profit_margin >= 30 ? "bg-green-100 text-green-800 hover:bg-green-200" : ""}
                                >
