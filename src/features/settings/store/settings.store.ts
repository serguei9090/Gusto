        ...
        }),
        {
            ...
            migrate: (persistedState: any, version: number) => {
                if (version === 0) {
                    ...
                    if (persistedState.modules && !persistedState.modules.calculators) {
                        persistedState.modules.calculators = true;
                    }
                    if (persistedState.moduleOrder && !persistedState.moduleOrder.includes("calculators")) {
                        persistedState.moduleOrder.push("calculators");
                    }
                }
