            ...
            <table className="w-full text-sm">
                <thead className="bg-muted/50 [&_tr]:border-b">
                    <tr>
                        ...
                        <th className="h-10 px-4 text-left align-middle font-medium text-muted-foreground">Price / Batch</th>
                        <th className="h-10 px-4 text-left align-middle font-medium text-muted-foreground">Price / Unit</th>
                ...
                <tbody className="[&_tr:last-child]:border-0">
                    {ingredients.map((ing) => (
                        <tr key={ing.id} className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                            ...
                            <td className="p-4 align-middle">${ing.currentPrice.toFixed(2)}</td>
                            <td className="p-4 align-middle">${ing.pricePerUnit.toFixed(2)} / {ing.unitOfMeasure}</td>
                            <td className="p-4 align-middle">
